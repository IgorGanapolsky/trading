    ...
    def get_price_data(
        ...
        try:
            ...
            # Fall back to yfinance
                ...
                return self._get_price_data_yfinance(symbols, timeframe, start_date, end_date, limit)
            ...
            for symbol in symbols:
                if symbol in snapshots:
                    ...
                    result[symbol] = {
                        ...
                        "last_trade_time": snap.latest_trade.timestamp.isoformat() if snap.latest_trade else None,
                        "volume": int(snap.daily_bar.volume) if snap.daily_bar else None,
                        "vwap": float(snap.daily_bar.vwap) if snap.daily_bar and hasattr(snap.daily_bar, 'vwap') else None
                    }
                else:
                    result[symbol] = None
...
def main():
    ...
    price_parser.add_argument('--timeframe', default='1Day', help='Timeframe (1Min, 5Min, 1Hour, 1Day)')
