...
def get_engaging_intro(day_num: int, day_of_week: str, lessons: list[dict]) -> str:
    ...
    # Different intros based on what happened
    if critical >= 2:
        return f"Today was a wake-up call. Two critical issues surfaced that could have derailed our entire trading operation. Here's what went wrong and how we're fixing it."
    elif critical == 1:
        return f"Every mistake is a lesson in disguise. Today we uncovered a critical flaw in our system - the kind that separates amateur traders from professionals who survive long-term."
    elif day_of_week == "Friday":
        return f"End of another trading week. Time to reflect on what worked, what didn't, and what needs to change before Monday's opening bell."
    elif day_of_week in ["Saturday", "Sunday"]:
        return f"Markets are closed, but the learning never stops. While other traders take the weekend off, we're refining our edge."
    elif len(lessons) > 10:
        ...
        return f"Another day in the 90-day journey to build a profitable AI trading system. Here's what we learned today."
