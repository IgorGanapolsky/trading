...
CONFIG = {
    "watchlist": [
        # Per CLAUDE.md Jan 19: SPY ONLY - IWM removed per LL-244
        "SPY",  # Best liquidity, tightest spreads - ONLY ticker allowed
    ],
    ...
    try:
        ...
        try:
            ...
            store_trade_trajectory(
                ...
                entry_state={"price": trade.get("strike", 0), "symbol": trade.get("symbol")},
