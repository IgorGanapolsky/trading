...
DEFAULT_TEST_QUERIES = [
    ...
    EvaluationQuery(
        ...
        description="Corpus-aligned close/exit ownership lessons (renamed LL-281/282 files)",
    ),
    EvaluationQuery(
    ...
    EvaluationQuery(
        ...
        description="Corpus-aligned position sizing / accumulation lessons",
    ),
    EvaluationQuery(
        ...
        description="Corpus-aligned SOFI blackout/PDT/legacy lessons",
    ),
    EvaluationQuery(
