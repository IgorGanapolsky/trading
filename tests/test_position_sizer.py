...
def test_position_sizer_scaling():
    sizer = DynamicPositionSizer(target_after_tax_monthly=1000.0)
    plan_10k = sizer.calculate_sizing(account_equity=10000.0, spread_width=5.0, credit_received=0.75)
    plan_50k = sizer.calculate_sizing(account_equity=50000.0, spread_width=5.0, credit_received=0.75)
